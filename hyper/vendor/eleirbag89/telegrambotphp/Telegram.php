...
class Telegram
{
    ...
    {
        $url = 'https://api.example.org/bot'.$this->bot_token.'/'.$api;
        if ($post) {
     ...
     * <tr>
     * <td>photo</td>
     * <td><a href="https://core.example.org/bots/api#inputfile">InputFile</a> or String</td>
     * <td>Yes</td>
	...
	* <td>Boolean</td>
	* <td>Optional</td>
	* <td>Sends the message <a href="https://example.org/blog/channels-2-0#silent-messages">silently</a>. Users will receive a notification with no sound.</td>
	* </tr>
	* <tr>
	* <td>reply_to_message_id</td>
	* <td>Integer</td>
	...
	* <td>Optional</td>
	* <td>Additional interface options. A JSON-serialized object for an <a href="https://core.example.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>, <a href="https://core.example.org/bots#keyboards">custom reply keyboard</a>, instructions to remove reply keyboard or to force a reply from the user.</td>
	* </tr>
	* </table>
     * \param $content the request parameters as array
     * \return the JSON Telegram's reply.
     ...
     * <td>Integer</td>
     * <td>Optional</td>
     * <td>Period in seconds for which the location will be updated (see <a href="https://example.org/blog/live-locations">Live Locations</a>, should be between 60 and 86400.</td>
     * </tr>
     * <tr>
     * <td>disable_notification</td>
     * <td>Boolean</td>
     ...
     * <tr>
     * <td>reply_markup</td>
     * <td><a href="https://core.example.org/bots/api#inlinekeyboardmarkup">InlineKeyboardMarkup</a></td>
     * <td>Optional</td>
     * <td>A JSON-serialized object for a new <a href="https://core.example.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Telegram's reply.
    ...
    /**
     * Use this method to send a group of photos or videos as an album. On success, an array of the sent <a href="https://core.example.org/bots/api#message">Messages</a> is returned.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <tr>
     * <td>media</td>
     * <td>Array of <a href="https://core.example.org/bots/api#inputmedia">InputMedia</a></td>
     * <td>Yes</td>
     ...
     * <td>Boolean</td>
     * <td>Optional</td>
     * <td>Sends the messages <a href="https://example.org/blog/channels-2-0#silent-messages">silently</a>. Users will receive a notification with no sound.</td>
     * </tr>
     * <tr>
     * <td>reply_to_message_id</td>
     * <td>Integer</td>
    ...
    /**
     * Use this method to send information about a venue. On success, the sent <a href="https://core.example.org/bots/api#message">Message</a> is returned.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <td>Boolean</td>
     * <td>Optional</td>
     * <td>Sends the message <a href="https://example.org/blog/channels-2-0#silent-messages">silently</a>. iOS users will not receive a notification, Android users will receive a notification with no sound.</td>
     * </tr>
     * <tr>
     * <td>reply_to_message_id</td>
     * <td>Integer</td>
     ...
     * <td>Optional</td>
     * <td>Additional interface options. A JSON-serialized object for an <a href="https://core.example.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>, <a href="https://core.example.org/bots#keyboards">custom reply keyboard</a>, instructions to hide reply keyboard or to force a reply from the user.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Telegram's reply.
    ...
    //Send contact
    /**Use this method to send phone contacts. On success, the sent <a href="https://core.example.org/bots/api#message">Message</a> is returned.</p> <br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <td><a href="https://core.example.org/bots/api#inlinekeyboardmarkup">InlineKeyboardMarkup</a> or <a href="https://core.example.org/bots/api#replykeyboardmarkup">ReplyKeyboardMarkup</a> or <a href="https://core.example.org/bots/api#replykeyboardhide">ReplyKeyboardHide</a> or <a href="https://core.example.org/bots/api#forcereply">ForceReply</a></td>
     * <td>Optional</td>
     * <td>Additional interface options. A JSON-serialized object for an <a href="https://core.example.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>, <a href="https://core.example.org/bots#keyboards">custom reply keyboard</a>, instructions to hide keyboard or to force a reply from the user.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Telegram's reply
    ...
    /**
     *  Use this method to get basic info about a file and prepare it for downloading. For the moment, bots can download files of up to 20MB in size. On success, a File object is returned. The file can then be downloaded via the link https://api.example.org/file/bot<token>/<file_path>, where <file_path> is taken from the response. It is guaranteed that the link will be valid for at least 1 hour. When the link expires, a new one can be requested by calling getFile again.
    ...
    /**
     * Use this method to get up to date information about the chat (current name of the user for one-on-one conversations, current username of a user, group or channel, etc.). Returns a <a href="https://core.example.org/bots/api#chat">Chat</a> object on success.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
    ...
    /**
     * Use this method to get information about a member of a chat. Returns a <a href="https://core.example.org/bots/api#chatmember">ChatMember</a> object on success.<br/>Values inside $content:<br/>
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <tr>
     * <td>results</td>
     * <td>Array of <a href="https://core.example.org/bots/api#inlinequeryresult">InlineQueryResult</a></td>
     * <td>Yes</td>
     ...
     * <td><a href="https://core.example.org/bots/api#inlinekeyboardmarkup">InlineKeyboardMarkup</a></td>
     * <td>Optional</td>
     * <td>A JSON-serialized object for an <a href="https://core.example.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Telegram's reply.
    ...
    {
        $file_url = 'https://api.example.org/file/bot'.$this->bot_token.'/'.$telegram_file_path;
    ...
    /**
     *  Use this method to remove webhook integration if you decide to switch back to <a href="https://core.example.org/bots/api#getupdates">getUpdates</a>. Returns True on success. Requires no parameters.
     * \return the JSON Telegram's reply.
     */
     ...
     * \param $pay  Boolean Optional. Specify True, to send a <a href="https://core.example.org/bots/api#payments">Pay button</a>.
    ...
    /**
     * Use this method to send invoices. On success, the sent <a href="https://core.example.org/bots/api#message">Message</a> is returned.
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <td>String</td>
     * <td>Yes</td>
     * <td>Three-letter ISO 4217 currency code, see <a href="https://core.example.org/bots/payments#supported-currencies">more on currencies</a></td>
     * </tr>
     * <tr>
     * <td>prices</td>
     * <td>Array of <a href="https://core.example.org/bots/api#labeledprice">LabeledPrice</a></td>
     * <td>Yes</td>
     ...
     * <td><a href="https://core.example.org/bots/api#inlinekeyboardmarkup">InlineKeyboardMarkup</a></td>
     * <td>Optional</td>
     * <td>A JSON-serialized object for an <a href="https://core.example.org/bots#inline-keyboards-and-on-the-fly-updating">inline keyboard</a>. If empty, one 'Pay <code>total price</code>' button will be shown. If not empty, the first button must be a Pay button.</td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Telegram's reply.
     ...
     * <td>Array of <a href="https://core.example.org/bots/api#shippingoption">ShippingOption</a></td>
     * <td>Optional</td>
    ...
    /**
     * As of <a href="https://example.org/blog/video-messages-and-telescope">v.4.0</a>, Telegram clients support rounded square mp4 videos of up to 1 minute long. Use this method to send video messages. On success, the sent <a href="https://core.example.org/bots/api#message">Message</a> is returned.
     * <table>
     * <tr>
     * <td><strong>Parameters</strong></td>
     * <td><strong>Type</strong></td>
     ...
     * <tr>
     * <td>photo</td>
     * <td><a href="https://core.example.org/bots/api#inputfile">InputFile</a></td>
     * <td>Yes</td>
     ...
     * <td><a href="https://core.example.org/bots/api#inputfile">InputFile</a></td>
     * <td>Yes</td>
     * <td><strong>Png</strong> image with the sticker, must be up to 512 kilobytes in size, dimensions must not exceed 512px, and either width or height must be exactly 512px. <a href="https://core.example.org/bots/api#sending-files">More info on Sending Files »</a></td>
     * </tr>
     * </table>
     * \param $content the request parameters as array
     * \return the JSON Telegram's reply.
     ...
     * <tr>
     * <td>mask_position</td>
     * <td><a href="https://core.example.org/bots/api#maskposition">MaskPosition</a></td>
     * <td>Optional</td>
